...
function TableViews() {
      const [state, set] = useState(viewOptions)
      ...
      return (
            <div>
                  ...
                  <Menu
                        ...
                        onClose={handleClose}
                  >
                        <DND setAnchorEl2={setAnchorEl} setChoose={setChoose} View={'Views'} display={'block'} direction={"vertical"} boxStyle={{ background: 'white' }} elementsStyle={{}} elements={state} />
                  </Menu>
