...
function Components({ provided, index, dragable, setOver, setAnchorEl2, setChoose, elements, View, isDragging, state, set, e, setAnchorEl, elementsStyle, anchorEl, Indexing }) {
      ...
      return (
            <div>
                  ...
                  {View === 'Views' && <ViewOptions dragable={dragable} set={set} state={state} setAnchorEl2={setAnchorEl2} setChoose={setChoose} Indexing={Indexing} setSearch={setSearch} setAnchorEl={setAnchorEl} anchorEl={anchorEl} searchValue={searchValue} elementsStyle={elementsStyle} e={e} isDragging={isDragging} SetIsOver={SetIsOver} mouseIsOver={mouseIsOver} />}
